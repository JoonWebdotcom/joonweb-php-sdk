...
/**
 * Method to Authenticate with JoonWeb.
 */
class Auth
{
    public const STATE_COOKIE_NAME = 'joonweb_app_state';
    public const STATE_SIG_COOKIE_NAME = 'joonweb_app_state_sig';
    public const SESSION_ID_COOKIE_NAME = 'joonweb_session_id';
    public const SESSION_ID_SIG_COOKIE_NAME = 'joonweb_session_id_sig';
    public const ACCESS_TOKEN_POST_PATH = 'api/admin/26.0/oauth/access_token';
